...
import { ProgressStep } from "../base/progress-step";
import { Text } from "../base/text";
import { Page } from "./page";
import { Divider } from "../base/divider";
import { BsChevronCompactRight } from "react-icons/bs";
import { ProgressSlide } from "../base/progess-slide";
  ...
  const dataModel = [
    {
      ...
      img: "https://i.imgur.com/ZZQJyap.png",
    },
    {
      index: 2,
      state: ProgressStepState.Pending,
      img: "https://i.imgur.com/XWQ0DhX.png",
    },
    {
      index: 3,
      state: ProgressStepState.Pending,
      img: "https://i.imgur.com/QGuaiYA.png",
    },
    {
      index: 4,
      state: ProgressStepState.Pending,
      img: "https://i.imgur.com/7htWZY5.png",
    },
    {
      index: 5,
      state: ProgressStepState.Pending,
      img: "https://i.imgur.com/fMVpzkc.png",
    },
  ];
  ...
  return (
    <Page>
      ...
      <div style={{ display: "flex", marginTop: "2rem" }}>
        ...
        <BsChevronCompactRight style={chevronStyle} />
        <ProgressSlide
          index={2}
          title="Apply Now"
          state={ProgressStepState.Completed}
