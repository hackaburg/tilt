  ...
  return (
    <Page>
      ...
      <SimpleCard>
        ...
        <Text>
          To analyze your users' data locally, use the JSON shown below. tilt
          does not support importing such data, so this is a readonly operation.
        </Text>
        <Text>
        ...
        <Text>
          A question can have a parent question, which determines whether the
          user can see the question. This is done through the{" "}
          ...
          depending on their answers. For instance you might show student
          specific questions, which professional attendees likely didn't answer,
          therefore expecting all users to answer this question might tilt your
          results. tilt, however, ensures all mandatory questions a user sees
      ...
      <SimpleCard>
        ...
        <Text>
          When the event is over, you might want to delete all user data but
          keep the settings such as your forms for your next event. tilt can
          delete all user data including your own account. To Prune the system,
          type <b>delete</b> in the following text field to confirm your choice.
