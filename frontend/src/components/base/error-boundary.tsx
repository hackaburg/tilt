...
const RenderError = ({ exception, info }: IRenderError) => {
  ...
  return (
    <FlexView vAlignContent="center" hAlignContent="center" height="100vh">
      <FlexView width="320px" column>
        ...
        <Text>
          You can include this error log along a quick description to reproduce
          this issue:
        </Text>
